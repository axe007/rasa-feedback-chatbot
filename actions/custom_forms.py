#
# Source: https://github.com/RasaHQ/financial-demo/blob/main/actions/custom_forms.py
#
...
# Load custom form configuration from a YAML file
custom_forms_config = (
    ruamel.yaml.safe_load(open(f"{here}/custom_forms_config.yml", "r")) or {}
).get("custom_forms", {})

# Set the maximum number of validation failures allowed
